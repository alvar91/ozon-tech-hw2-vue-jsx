      ...
      <main class={$style.main}>
        <section class={$style.card}>
          <article class={$style.card__about}>
            ...
            <button
              class={[$style["card__user-status"], $style[`card__user-status--${accountStatus}`]]}
            >
            ...
            <ul class={$style.card__list}>
              ...
              <li class={$style["card__list-item"]}>
                <ul class={$style["card__sub-list"]}>
                  ...
                  <li class={$style.card__item}>
                    <span class={[$style.card__status, $style[`card__status--${FPStatus}`]]}>
                      {FP_STATUS[FPStatus]}
                    </span>
                    <span
                      class={[$style.card__status, $style[`card__status--${applicationStatus}`]]}
                    >
          ...
          <article class={$style.card__detailed}>
            ...
            <form action="#" class={$style.card__form}>
              <InputText
                ...
                placeholder={"Фамилия"}
              />
              <InputText title={"Имя"} name={"name"} value={firstName} placeholder={"Имя"} />
              <InputText
                title={"Отчество"}
                name={"patronymic"}
                value={lastName}
              ...
              <Select title={"Гражданство"} name={"citizenship"} value={citizenship} />
